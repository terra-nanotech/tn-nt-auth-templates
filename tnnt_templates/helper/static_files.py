...
from tnnt_templates import __title__, __version__
from tnnt_templates.constants import TNNT_TEMPLATES_STATIC_DIR
...
def calculate_integrity_hash(relative_file_path: str) -> str:
    ...
    :param self:
    :type self:
    :param relative_file_path: The file path relative to the `tnnt_templates/static/tnnt_templates` folder
    :type relative_file_path: str
    :return: The integrity hash
    :rtype: str
    """

    file_path = os.path.join(TNNT_TEMPLATES_STATIC_DIR, relative_file_path)
...
def get_theme_hook_static(
    ...
    :param static_file: The file path relative to the `tnnt_templates/static/tnnt_templates` folder
    ...
    return_value = {
        "url": urljoin(
            ...
            url=f"tnnt_templates/{static_file}",
        ),
    }
