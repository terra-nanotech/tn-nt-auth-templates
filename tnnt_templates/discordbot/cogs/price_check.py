    ...
    async def price(self, ctx):
        ...
        for market in markets:
            ...
            market_data = requests.post(
                ...
                json={"market_name": market["api_key"], "items": [{"name": item_name}]},
            )
            ...
            if market_data.status_code == 200:
                ...
                if has_thumbnail is False:
                    embed.set_thumbnail(
                        ...
                        ).format(type_id=market_json["appraisal"]["items"][0]["typeID"])
                    )
                ...
                if (
                    market_json["appraisal"]["items"][0]["prices"]["buy"]["order_count"]
                    == 0
                ):
